...
@Component({
  selector: 'app-sigobebiendo',
  templateUrl: './sigobebiendo.component.html',
  animations: [
    trigger(
      'inOutAnimation',
      [
  ...
  styleUrls: ['./sigobebiendo.component.scss']
})
export class SigobebiendoComponent implements OnInit {
