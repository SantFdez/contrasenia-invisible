...
@Component({
  selector: 'app-irfiesta',
  templateUrl: './irfiesta.component.html',
  animations: [
    trigger(
      'inOutAnimation',
      [
  ...
  styleUrls: ['./irfiesta.component.scss']
})
export class IrfiestaComponent implements OnInit {
  ...
  op1() { this.sound.fade(1, 0, 1000);
    setTimeout(() => {
       window.location.href = ('/d8/amigo');
    }, 500);
  }

  op2() { this.sound.fade(1, 0, 1000);
    setTimeout(() => {
       window.location.href = ('/d8/psicologo');
    }, 500);
  }

  op3() { this.sound.fade(1, 0, 1000);
    setTimeout(() => {
       window.location.href = ('/d8/internet');
    }, 500);
  }

  insta() { this.sound.fade(1, 0, 1000);
    // setTimeout(() => {
