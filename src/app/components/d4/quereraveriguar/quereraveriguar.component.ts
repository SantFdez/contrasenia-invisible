...
@Component({
  selector: 'app-quereraveriguar',
  templateUrl: './quereraveriguar.component.html',
  animations: [
    trigger(
      'inOutAnimation',
      [
  ...
  styleUrls: ['./quereraveriguar.component.scss']
})
export class QuereraveriguarComponent implements OnInit {
  ...
  constructor() {
    this.sound = new Howl({
      src: ['../../../assets/music/d4-quieroaveriguarlo.mp3'],
      loop: true,
      volume: 1,
      autoplay: true,
      onload: (event2) => {
